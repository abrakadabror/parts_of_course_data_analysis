...
revenue_adjusted_list = vip_list.copy() #kopiujemy cala liste bez zmieniania dnaych w liscie
...
revenue_adjusted_list[1]  = (0.0, 0.0) # zmieniamy obie zmienne w drugim indexie[1]na 0
print(revenue_adjusted_list)
